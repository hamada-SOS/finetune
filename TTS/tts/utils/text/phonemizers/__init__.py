...
from TTS.tts.utils.text.phonemizers.somali_phonemizer import SO_SO_Phonemizer
...
if SO_SO_Phonemizer is not None:
    PHONEMIZERS[SO_SO_Phonemizer.name()] = SO_SO_Phonemizer
    DEF_LANG_TO_PHONEMIZER["so-so"] = SO_SO_Phonemizer.name()
